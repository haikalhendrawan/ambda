  ...
  async addEmployee(client: PoolClient, data: EmpDataExcel){
    try{
      ...
      const q = `INSERT INTO employee
                  ...
                  RETURNING *`;
      const values = [
        No, NIPFormatBaru, NIP, NamaGelar, GelarDepan, Nama, GelarBelakang, NamaTerakhir, Sex, BMI, KetBMI, Pangkat, Gol, GolTMT, Eselon, EselonTMT, TMTJabatan, TempatLahir, TanggalLahir, Usia, PendidikanTerakhir, PendidikanTerakhirShrt, Agama, Jabatan, KodeUnit, UnitEselonII, UnitEselonIII, UnitEselonIV, UnitKerja, UnitSulitTrs, RemoteZone, Status, AktifYN, UnitPertama, MasaKerjaGolonganThn, MasaKerjaGolonganBln, MasaKerjaSeluruhnyaThn, MasaKerjaSeluruhnyaBln, HP, Email
      ];
